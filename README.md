...
<img src="etching_process.png" alt="식각 공정" width="300"/>

- **식각 전**: 포토레지스트로 보호된 기판
- **식각**: 부식액으로 불필요한 부분 제거
- **식각 후**: 필요한 회로 패턴만 남음

> 📚 **식각 공정 자세히 알아보기**: [LG Display - 디스플레이 상식사전](https://news.lgdisplay.com/2022/12/%EB%94%94%EC%8A%A4%ED%94%8C%EB%A0%88%EC%9D%B4-%EC%83%81%EC%8B%9D%EC%82%AC%EC%A0%84-22-%EC%8B%9D%EA%B0%81-etching/)
...
---
### 데이터 출처
Samsung Brightics AI 커뮤니티: [제조현장 데이터 분석 및 제조장비 유지보수](https://www.brightics.ai/community/knowledge-sharing/detail/7098)
---
